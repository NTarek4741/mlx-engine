...
class AnthropicChoice(BaseModel):
    """Choice in the Anthropic chat completion response."""
...
class AnthropicChatCompletionResponse(BaseModel):
    """Anthropic response from chat completion endpoint."""

    id: str = Field(description="Unique identifier for the response")
    choices: list[AnthropicChoice] = Field(description="Response choices")
    created: int = Field(description="Unix timestamp of creation")
    model: str = Field(description="Model used")
